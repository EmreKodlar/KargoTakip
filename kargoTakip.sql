--cmd içine sýrayla sqlplus , kullanýcý adý , parola, SET SQLBLANKLINES ON; yaz!!! Boþ satýrlarý komut olarak algýlamasýn...
--SET DEFINE OFF;
...
--NOT: ÇOK SAÇMA AMA TRIGGER KELÝMESÝNÝ KÜÇÜK HARFLERLE YAZINCA ÇALIÞTI.
--NOT 2: END; 'DEN SONRA / (SLASH) KOY...
...
VALUES ('emre','çiftçi','1111111111','2222222','Gönderen bilgileri gelecek','Alýcý adresi gelecek','Sincan','Ankara','05554443322','TV','TKP0002','04-12-2021','Ankara-Sincan');
